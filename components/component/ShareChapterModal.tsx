...
const ShareChapterModal: React.FC<ShareChapterModalProps> = ({ isOpen, onClose, chapterId }) => {
  ...
  const generateShareLink = async () => {
    try {
      ...
      const response = await axios.post(`${apiUrl}/chapters/${chapterId}/share`, 
        { access: shareAccess },
...
export default ShareChapterModal;